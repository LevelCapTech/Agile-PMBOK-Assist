...
- PR種別に応じて対応するテンプレートを必ず使用する：
  - DESIGN PR → [design.md](../PULL_REQUEST_TEMPLATE/design.md)
  - IMPLEMENT PR → [PULL_REQUEST_TEMPLATE.md](../PULL_REQUEST_TEMPLATE/PULL_REQUEST_TEMPLATE.md)
  - RESEARCH PR → [research.md](../PULL_REQUEST_TEMPLATE/research.md)
  - BLIND PR → [blind.md](../PULL_REQUEST_TEMPLATE/blind.md)
