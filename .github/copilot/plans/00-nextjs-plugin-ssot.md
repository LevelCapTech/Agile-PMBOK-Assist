...
| ---- | --- | ----- | ----------------------- | --------- | --------------- |
| H-01 | 規約確認 | SSOT 規範の整合性確認 | instructions の内容が Issue 要件と一致していることを確認する | 規約の抜け/重複<br>・AppProvider が唯一の DI ポイントとして明文化されている<br>・contracts が interface のみで構成されることが明示されている<br>・ESLint による技術的制約が記載されているか、または別 Issue 化の方針が明確である | 要件が満たされている |
