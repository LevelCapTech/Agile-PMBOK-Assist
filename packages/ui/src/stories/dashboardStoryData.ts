...
export const dashboardHeaderView: DashboardHeaderView = {
  title: "プロジェクト選択",
...
export const dashboardProjects: DashboardProjectItem[] = [
  {
    id: "prj-1",
...
export const dashboardMembers: DashboardMemberItem[] = [
  {
    id: "member-1",
    displayName: "田中太郎",
    role: "プロジェクトマネージャー",
...
export const budgetSeries: BudgetSeriesPoint[] = [
...
export const settingsActions: SettingAction[] = [
  {
    id: "project-settings",
    label: "プロジェクト設定",
